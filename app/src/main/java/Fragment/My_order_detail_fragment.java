...
public class My_order_detail_fragment extends Fragment {
    ...
    private Button btn_cancle, btn_track;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_track = (Button) view.findViewById(R.id.btn_order_detail_track);
        ...
        btn_track.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fm = new GoogleMap_fragment();
...
//                Toast.makeText(getActivity().getApplicationContext(), "dddddddd", Toast.LENGTH_SHORT).show();
            }
        });
